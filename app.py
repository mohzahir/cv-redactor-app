...
if uploaded_files:
    if st.button("Process CVs"):
        ...
        try:
            ...
            # --- NEW: Save the finished Zip into secure memory ---
            st.session_state.zip_data = zip_buffer.getvalue()
            st.success("All documents processed successfully! You can now download.")
            
        except Exception as e:
            st.error(f"An error occurred while processing: {e}")

# --- NEW: Only show the download button if the Zip exists in memory ---
